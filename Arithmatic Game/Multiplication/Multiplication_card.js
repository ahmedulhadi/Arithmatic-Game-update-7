...
// audios
var correct_audio = new Audio('Arithmatic Game\\music\\correct_ans.wav');
var game_over_audio = new Audio('Arithmatic Game\\music\\end.mp3');
var wrong_audio = new Audio('Arithmatic Game\\music\\mixkit-wrong-answer-fail-notification-946.wav');
...
function move_to_study_material() {
    window.location.replace("Arithmatic Game\\Study material\\Multiplication_study_material.html")
}
...
//when exit is clicked-- redirect to main page
